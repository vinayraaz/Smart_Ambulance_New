...
public class Stock_DisposableAdapter extends RecyclerView.Adapter<Stock_DisposableAdapter.DisposableViewHolder> {
    ...
    public Stock_DisposableAdapter(Context context, List<Stock_Medical_ParshingModel> stock_medical_parshingModels) {
    ...
    @Override
    public DisposableViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.meterial_des_list_details, parent, false);
        Stock_DisposableAdapter.DisposableViewHolder contactViewHolder = new Stock_DisposableAdapter.DisposableViewHolder(view);
        return contactViewHolder;
    }

    @Override
    public void onBindViewHolder(DisposableViewHolder holder, final int position) {
    ...
    public class DisposableViewHolder extends RecyclerView.ViewHolder {
        ...
        public DisposableViewHolder(View itemView) {
            super(itemView);
